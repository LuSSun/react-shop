...
class Home extends Component {
	...
	clickHandle = () => {
		this.props.login(656)
		this.props.dispatch1()
		console.log(this.props)
		// this.props.history.push('/bar656')

	}
	render() {
		return (
			<div className="index" style={{ background: '#fff', paddingBottom: '0.2rem' }}>
				<div className="header acea-row row-center-wrapper">
					<div className="logo"><img src={this.state.logoUrl} alt="" /></div>
